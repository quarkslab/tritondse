...
ARCHS = {
    Architecture.X86:     Arch('eax', 'eip', 'ebp', 'esp', 'eax', [], b"\xf4"),                                         # FIXME: Use OPCODE.X86.HLT
    Architecture.X86_64:  Arch('rax', 'rip', 'rbp', 'rsp', 'rax', ['rdi', 'rsi', 'rdx', 'rcx', 'r8', 'r9'], b"\xf4"),   # FIXME: Use OPCODE.X86.HLT
    Architecture.AARCH64: Arch('x0', 'pc', 'sp', 'sp', 'x8', ['x0', 'x1', 'x2', 'x3', 'x4', 'x5', 'x6', 'x7'], b"")     # FIXME: Use OPCODE.AARCH64.HLT
    # ARM ?
}
